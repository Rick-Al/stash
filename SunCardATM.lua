-- Original by connorhedgehog
-- https://github.com/connorhedgehog/silly-subway-system
-- https://pinestore.cc/projects/183/silly-subway-system
local ed = require("ccryptolib.ed25519")
local random = require("ccryptolib.random")
local expect = require "cc.expect".expect
local currency = "numismatic-overhaul:silver_coin"
...
insertCardScreen.write("SunCard Kiosk")
insertCardScreen.setTextColor(colors.white)
...
mainScreen.write("SunCard Kiosk")
mainScreen.setTextColor(colors.white)
...
depositScreen.write("SunCard Kiosk")
depositScreen.setTextColor(colors.white)

PrimeUI.centerLabel(depositScreen, 1, 3, monitor_x, "Drop silver", colors.white, colors.blue)
...
thanksScreen.write("SunCard Kiosk")
thanksScreen.setTextColor(colors.white)

PrimeUI.centerLabel(thanksScreen, 1, 4, monitor_x, "Thanks for", colors.white, colors.blue)
PrimeUI.centerLabel(thanksScreen, 1, 5, monitor_x, "using SunCard", colors.white, colors.blue)
...
balanceScreen.write("SunCard Kiosk")
balanceScreen.setTextColor(colors.white)
